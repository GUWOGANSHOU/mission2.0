...
<main class="main-ren">
    ...
    <ul>
        ...
        <li class="re-2" id="expresstask" onClick="window.location='../../../Mission2.0/tasknew/jbtask.php'">快递任务</li>
    </ul>
    <ul>
        <li class="re-3">兼职任务</li>
        <li class="re-3">物品收购</li>
        <li class="re-3">跑腿任务</li>
    </ul>
    <ul>
        <li class="re-2">艺术任务</li>
        <li class="re-2" id="print" onClick="window.location='../../../Mission2.0/print/print-no1.html'">超级打印</li>
    </ul>
...
$(document).ready(function(){
	...
	$("ul li").on("touchstart",function(){window.location="TaskIssue.php?Title="+$(this).text()+"&UserId="+$.session.get("PhoneNumber");});
	$('#expresstask').unbind("touchstart");
	$("#print").unbind("touchstart");
})
</script>