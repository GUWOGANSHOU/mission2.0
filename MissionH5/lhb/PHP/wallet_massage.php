...
<header>
	<a  href="message.php"> <img src="http://www.gaocimi.cn/MissionH5/lhb/images/return.gif"></a>钱包
</header>
<main class="ma-ea">
...
<script type="text/javascript">
	...
	$.ajax({
		...
		Type:"GET",
		dataType:"Json",
		success:function(data){$.each(data,function(index,comment){$("#balancemoney").text(comment.WalletBalance)})},
