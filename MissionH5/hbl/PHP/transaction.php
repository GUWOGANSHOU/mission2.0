...
<header style="position: fixed">
    <a href="wallet.php"><img src="../images/return.gif"></a>我的账单
</header>
...
$.ajax({
		url:"../handfile/mybillhandle.php?UserId="+$.session.get("PhoneNumber"),
		Type:"GET",
		dataType:"Json",
	   success:function(data){$.each(data,function(index,comment){
		   ...
		   if(comment.Reason==0){fuhao="-"}else{fuhao="+"};$("#pole").after("<section><img id='tou' src='"+urlPay+"'><div class='nam-tim'><ul><li class='name-n'>"+comment.body+"</li><li class='ta-tm'><data id='PayTime' value='08-04'>"+comment.SendPayDate+"</data>&nbsp; <time ></time></li></ul></div><div class='amount'>"+fuhao+comment.TotalAmount+"￥"+"余额:"+comment.WalletAccount+"</div></section>")})},
